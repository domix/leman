...
public static String quitarSimbolo(String cadena, char simbolo){
      ...
      public static String formatAccount(String account) {
        ...
        if(account.length() == 10)
          result = account.substring(0, 4) + "-" + account.substring(4, 7) + "-" + account.substring(7, 10);
        return result;
      }
      public static String decodeAccount(String account) {
        String result = "";
        if(account.length() == 12) {
          //0123-456-789
          //0123  56  89
          result = account.substring(0, 4) + account.substring(5, 8) + account.substring(9, 12);
        }
        return result;
      }
}
