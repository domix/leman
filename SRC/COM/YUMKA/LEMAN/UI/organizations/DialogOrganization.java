package com.yumka.leman.ui.organizations;
...
public class DialogOrganization extends JDialog {
   ...
   *
   * @param frame JFrame
   */public DialogOrganization(JFrame frame, InternalFrameUsers frameUsers) {
    super(frame, "Leman-Usuarios", true);
    this.frame = frame;
