...
public class OrganizationBeanTableModel implements TableModel {
  OrganizationBean[] results;
  int numcols, numrows; // How many rows and columns in the table

  /**
   *
   * @param users UserBean[]
   */
  public OrganizationBeanTableModel(OrganizationBean[] users) {
    this.results = users;
    numcols = 3; // How many columns?
    numrows = users.length; // How many rows?
  }
  ...
  public Object getValueAt(int row, int column) {
    ...
    switch (column) {
      case 0:
        result = (String) ( ( (OrganizationBean) results[row]).getName());
        break;
      case 1:
        result = (String) ( ( (OrganizationBean) results[row]).getAddress());
        break;
      case 2:
        result = (String) ( ( (OrganizationBean) results[row]).getTelephone());
        break;
      default:
        result = "_________";
        break;
