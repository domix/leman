 ...
 * @version 1.0
 */
public class UserBeanTableModel implements TableModel {
  UserBean[] results;
   ...
   */
  public UserBeanTableModel(UserBean[] users) {
    this.results = users;
  ...
  public Object getValueAt(int row, int column) {
    ...
    switch (column) {
      case 0:
        result = (String) ( ( (UserBean) results[row]).getLogin());
        break;
      case 1:
        result = (String) ( ( (UserBean) results[row]).getName());
        break;
      case 2:
        result = (String) ( ( (UserBean) results[row]).getCompany());
        break;
      case 3:
        result = (String) ( ( (UserBean) results[row]).getJobposition());
        break;
      default:
        result = "_________";
        break;
