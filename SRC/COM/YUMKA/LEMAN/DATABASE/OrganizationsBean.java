...
// extends- 
{
     ...
     */
    public void copy(OrganizationsBean bean) {
        setId(bean.getId());
    ...
    public String toString() {
        return   "\n[ORGANIZATIONS] "
                 + "\n - ORGANIZATIONS.ID = " + (id_is_initialized ? ("[" + (id == null ? null : id.toString()) + "]") : "not initialized") + ""
                 + "\n - ORGANIZATIONS.NAME = " + (name_is_initialized ? ("[" + (name == null ? null : name.toString()) + "]") : "not initialized") + ""
                 + "\n - ORGANIZATIONS.ADDRESS = " + (address_is_initialized ? ("[" + (address == null ? null : address.toString()) + "]") : "not initialized") + ""
                 + "\n - ORGANIZATIONS.TELEPHONE = " + (telephone_is_initialized ? ("[" + (telephone == null ? null : telephone.toString()) + "]") : "not initialized") + ""
            ;
    }
